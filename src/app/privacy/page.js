  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-slate-900 font-sans" dir="rtl">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-black text-[#5c2d91] mb-2">سياسة الخصوصية</h1>
        <p className="text-slate-500 text-sm mb-10">آخر تحديث: فبراير 2026</p>

        <div className="space-y-6 text-slate-600 leading-relaxed">
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">1. المعلومات التي نجمعها</h2>
            <p>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">2. كيف نستخدم المعلومات</h2>
            <p>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">3. ملفات تعريف الارتباط (الكوكيز)</h2>
            <p>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">4. مشاركة المعلومات</h2>
            <p>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">5. أمان البيانات</h2>
            <p>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-[#5c2d91] mb-3">6. حقوقك</h2>
            <p>
