...
export const metadata = {
  ...
  description:
    "جدول مباريات اليوم بث مباشر عبر موقع يلا شوت yallashoot. تابع بث مباشر يلا شوت بدون تقطيع، وتعرف على القنوات الناقلة وتوقيت جميع مباريات اليوم في مختلف الدوريات والبطولات العالمية.",
  keywords: [
    "yallashoot",
    "يلا شوت",
    "yalla live",
