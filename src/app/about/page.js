...
export const metadata = {
  title: "من نحن — يلا شوت",
  description:
    "تعرف على فريق يلا شوت (Yallashoot) ورؤيتنا لمستقبل الإعلام الرياضي العربي. منصة رقمية متخصصة في تقديم جداول مباريات اليوم بث مباشر، النتائج المباشرة، وتغطية شاملة لكل الأحداث الرياضية.",
  alternates: {
  ...
  openGraph: {
    title: "من نحن — يلا شوت",
    description:
      "تعرف على فريق يلا شوت ورؤيتنا لمستقبل الإعلام الرياضي العربي. منصة متخصصة في مباريات اليوم بث مباشر.",
  ...
  twitter: {
    ...
    title: "من نحن — يلا شوت",
    description:
      "تعرف على فريق يلا شوت ورؤيتنا لمستقبل الإعلام الرياضي العربي. منصة متخصصة في مباريات اليوم.",
    images: ["/og-image.jpg"],
  },
};
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="bg-[#1e293b] border border-slate-800 rounded-2xl p-8 mb-8 shadow-sm transition-colors duration-300">
          <p className="text-slate-300 leading-loose">
            يلا شوت (Yallashoot) هي منصة رقمية متخصصة في تقديم جداول المباريات
            والنتائج المباشرة لكرة القدم. نهدف إلى توفير تجربة مستخدم سلسة
            وحديثة تمكّن عشاق الرياضة من متابعة أحدث المباريات في مختلف الدوريات
            والبطولات العالمية لحظة بلحظة، مع التركيز على السرعة والدقة في نقل
            المعلومة.
          </p>
        </section>
