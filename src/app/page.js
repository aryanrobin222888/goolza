...
export const metadata = {
  ...
  description:
    "تابع أهم مباريات اليوم بث مباشر عبر يلا شوت الجديد yallashoot. تغطية شاملة وحصرية لنتائج المباريات، بث مباشر يلا شوت بدون تقطيع، كورة لايف بجودة عالية تناسب الجوال والإنترنت الضعيف.",
  keywords: [
    "yallashoot",
    "يلا شوت",
    "yalla live",
