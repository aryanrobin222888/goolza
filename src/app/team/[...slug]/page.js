...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${teamName} - إحصائيات واللاعبون | يلا شوت`,
    description: `تابع آخر إحصائيات نادي ${teamName} في الموسم الحالي. تشكيلة اللاعبين، نتائج المباريات السابقة، مواعيد اللقاءات القادمة، وترتيب الفريق في الدوري بالتفصيل على يلا شوت.`,
