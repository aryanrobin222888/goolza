...
export default function RightSidebarAd() {
  return (
    <aside className="hidden md:block w-[300px] shrink-0 sticky top-20 h-[600px] self-start mt-6 z-20">
      <div className="w-[300px] h-[600px] rounded-xl overflow-hidden shadow-2xl border border-slate-800/80 bg-slate-900/40 backdrop-blur-sm transition-all duration-300 hover:border-emerald-500/30 group">
        <a
          href="https://refpa3665.com/L?tag=d_5620219m_45415c_&site=5620219&ad=45415"
          target="_blank"
